...
public class custom_hod_view_students extends BaseAdapter  {
...
//    Button edit;
    ...
    public custom_hod_view_students(Context appcontext, String[] id, String[] ktu_id, String[] fname, String[] lname, String[] dob, String[] house, String[] place, String[] post, String[] pin, String[] district, String[] email, String[] phno, String[] photo, String[] semester){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_hod_view_students,null);
