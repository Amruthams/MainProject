...
public class custom_tutor_viewstudents extends BaseAdapter  {
    ...
    public custom_tutor_viewstudents(Context appcontext, String[] id, String[] ktu_id, String[] fname,
                                     String[] lname, String[] dob,String[] house,String[] place,String[] post,
                                     String[] pin,String[] district,String[] email,String[] phno,String[] photo,String[] semester){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_tutor_viewstudents,null);
