...
public class tutor_view_students extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_view_students);

        lvs = (ListView) findViewById(R.id.tutorviewstudents);
...
//                          Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                               ...
                               lvs.setAdapter(new custom_tutor_viewstudents(getApplicationContext(),id,ktu_id,fname,lname,dob,house,place,post,pin,district,email,phno,photo,semester));
    ...
    public void onClick(View v) {
        startActivity(new Intent(getApplicationContext(),tutor_add_students.class));
    }
}