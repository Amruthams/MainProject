...
import com.example.edulinknew.databinding.ActivityTeacherHomeBinding;
...
public class teacher_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarTeacherHome.toolbar);
//        binding.appBarTeacherHome.fab.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        });
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_teacher_home);
