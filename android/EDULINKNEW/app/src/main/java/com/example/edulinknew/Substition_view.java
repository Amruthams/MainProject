...
public class Substition_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_substition_view);
        ...
        String url = "http://" + hu + ":8000/myapp/view_substitution/";
...
//
                                ...
                                lv1.setAdapter(new custom_substitution_view(getApplicationContext(),pname,semester,dates,hour,name));
