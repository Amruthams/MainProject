...
public class students_view_attendance extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_students_view_attendance);

        ssem=findViewById(R.id.spinner24);
    ...
    public void onClick(View v) {
        ...
        String url = "http://" + hu + ":8000/myapp/students_view_attendance/";
