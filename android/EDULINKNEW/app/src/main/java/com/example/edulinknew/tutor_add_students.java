...
public class tutor_add_students extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_add_students);
...
//                new DatePickerDialog(tutor_add_students.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
//            }
//        });
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dod= new DatePickerDialog(tutor_add_students.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH));
        ...
        ArrayAdapter<String> ad=new ArrayAdapter<String>(tutor_add_students.this,android.R.layout.simple_list_item_1,sems);
        s1.setAdapter(ad);
    ...
    public void onClick(View v) {
        ...
        String url = "http://" + hu + ":8000/myapp/tutor_add_student/";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                Intent i=new Intent(getApplicationContext(),tutor_home.class);
                                startActivity(i);
