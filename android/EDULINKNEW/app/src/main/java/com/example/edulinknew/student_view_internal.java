...
public class student_view_internal extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_view_internal);
    ...
    public void onClick(View v) {
        ...
        String url = "http://" + hu + ":8000/myapp/students_view_internal/";
...
//                          Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lv1.setAdapter(new custom_students_view_internal(getApplicationContext(),subject,mark));
