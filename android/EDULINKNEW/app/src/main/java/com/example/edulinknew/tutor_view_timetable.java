...
public class tutor_view_timetable extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_view_timetable);
...
//                Toast.makeText(tutor_view_timetable.this, "hiiiiiiiiiiiiiiiiii", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(this, "hlooooo", Toast.LENGTH_SHORT).show();
//                Toast.makeText(tutor_view_timetable.this, "hloooooooooooooooo", Toast.LENGTH_SHORT).show();
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":8000/myapp/hod_view_timetable/";
