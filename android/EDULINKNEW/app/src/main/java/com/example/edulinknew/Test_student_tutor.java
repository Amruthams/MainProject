...
public class Test_student_tutor extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapterMessages = new MessagesAdapter(Test_student_tutor.this);
		...
		final String sid1=sh.getString("user", "");
					...
					String url = "http://" + ip + ":8000/myapp/in_message/";
		                 ...
		                 //   Toast.makeText(getApplicationContext(),response,Toast.LENGTH_SHORT).show();
		                    ...
		                    try {
		                        ...
		                        if(sucs.equalsIgnoreCase("ok"))
		                        {
									...
									Toast.makeText(getApplicationContext(),"Tutor not assigned ",Toast.LENGTH_SHORT).show();
...
startActivity(ij);
		...
		ad=new Runnable() {
			...
			public void run() {
				...
				String url = "http://" + ip + ":8000/myapp/view_message/";
			                        ...
			                        try {
			                            ...
			                            if(sucs.equalsIgnoreCase("ok"))
			                            {
			                            	...
			                            	for(int i=0;i<jsa.length();i++)
			                            	{
			                            		...
			                            		fid[i]=jsob.getString("type");
			                            		mid[i]=jsob.getString("id");
			                            		lastid=mid[i];
			                            		
			                            		if(fid[i].equalsIgnoreCase("staff"))
			    					    		{
													ChatMessage	message1 = new ChatMessage();
													message1.setUsername(jsonObj.getString("sname"));
