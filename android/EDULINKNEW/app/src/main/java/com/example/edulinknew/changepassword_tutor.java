...
public class changepassword_tutor extends AppCompatActivity implements View.OnClickListener, TextWatcher {
    EditText e1,e2,e3;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_changepassword_tutor);
    ...
    public void onClick(View v) {
        ...
        if (op.length()==0) {
            ...
            e3.setError("Password Mismatched");
        }
        else{
