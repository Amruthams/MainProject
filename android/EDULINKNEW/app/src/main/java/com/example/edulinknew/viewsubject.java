...
public class
viewsubject extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> ad=new ArrayAdapter<String>(viewsubject.this,android.R.layout.simple_list_item_1,sems);
        s1.setAdapter(ad);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lvs.setAdapter(new custom_viewsubject(getApplicationContext(),sid,pid,subname,sem,progrm));
