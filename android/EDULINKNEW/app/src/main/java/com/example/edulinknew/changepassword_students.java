...
public class changepassword_students extends AppCompatActivity implements View.OnClickListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_changepassword_students);
