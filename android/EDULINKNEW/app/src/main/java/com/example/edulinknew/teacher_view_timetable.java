...
public class teacher_view_timetable extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_view_timetable);
...
//                Toast.makeText(teacher_view_timetable.this, "hiiiiiiiiiiiiiiiiii", Toast.LENGTH_SHORT).show();
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":8000/myapp/teacher_view_timetable/";
...
//                Toast.makeText(this, "hlooooo", Toast.LENGTH_SHORT).show();
//                Toast.makeText(teacher_view_timetable.this, "hloooooooooooooooo", Toast.LENGTH_SHORT).show();
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":8000/myapp/teacher_view_timetable/";
