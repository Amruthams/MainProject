...
public class hod_view_students extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hod_view_students);
        ...
        show_dept();
        ArrayAdapter<String> ad=new ArrayAdapter<String>(hod_view_students.this,android.R.layout.simple_list_item_1,sems);
        s2.setAdapter(ad);
...
//                          Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        lvs.setAdapter(new custom_hod_view_students(getApplicationContext(), id, ktu_id, fname, lname, dob, house, place, post, pin, district, email, phno, photo, semester));
